#include <iostream>
#include <cstring>
#include "../header/Genie_Capture.h"
using namespace std;
...
/*
	...
	void Genie_Genie_Capture::Init()
	{
	
	}
*/

void Genie_Capture::screen_capture(std::string path) {
	...
	// DIB 파일을 생성한다.
	FILE *p_file = fopen(path.c_str(), "wb");//"C:\\Users\\user\\Desktop\\image.bmp", "wb");
	if (p_file != NULL) {
